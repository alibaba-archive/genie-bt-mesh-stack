...
ota_length = 0x15B00
rom_ver    = 0x0007
BIM_BIN_FILE   := $(SOURCE_ROOT)platform/mcu/$(HOST_MCU_FAMILY)/bin/bk3435_ble_bim_8M.bin
STACK_BIN_FILE := $(SOURCE_ROOT)platform/mcu/$(HOST_MCU_FAMILY)/bin/bk3435_ble_stack_8M.bin
