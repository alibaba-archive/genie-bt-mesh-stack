...
uint32_t **_jump_table_base = (uint32_t**)0x1fff0800;
...
{
    _jump_table_base[224 + irq_num] = (uint32_t *)irq_handler;
}
...
{
    _jump_table_base[224 + irq_num] = NULL;
}
