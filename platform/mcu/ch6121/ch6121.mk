...
$(NAME)_VERSION    := 0.0.1
$(NAME)_SUMMARY    := driver & sdk &ble controller for platform/mcu ch6121
...
GLOBAL_LDFLAGS += -T board/ch6121evb/configs/gcc_eflash.ld
GLOBAL_INCLUDES += csi/csi_driver/phyplus/ch6121/include \
...
$(NAME)_SOURCES += csi/csi_driver/phyplus/common/adc.c           \
                   ...
                   csi/csi_driver/phyplus/ch6121/startup.S       \
                   csi/csi_driver/phyplus/ch6121/lpm_arch_reg_save.S  \
                   csi/csi_driver/phyplus/ch6121/system.c        \
                   csi/csi_driver/phyplus/ch6121/isr.c           \
                   csi/csi_driver/phyplus/ch6121/lib.c           \
                   csi/csi_driver/phyplus/ch6121/device.c        \
                   csi/csi_driver/phyplus/ch6121/pinmux.c        \
                   csi/csi_driver/phyplus/ch6121/jump_table.c    \
                   csi/csi_driver/phyplus/ch6121/lib_printf.c    \
                   csi/csi_driver/phyplus/ch6121/power_manager.c \
                   csi/csi_driver/phyplus/ch6121/reboot.c    \
                   csi/csi_driver/phyplus/ch6121/systick.c    \
                   csi/csi_driver/phyplus/ch6121/sys_freq.c
...
GLOBAL_INCLUDES += $(L_PATH_BT)/hci_ch6121/hci\
                   $(L_PATH_BT)/hci_ch6121/controller \
                   $(L_PATH_BT)/hci_ch6121

$(NAME)_PREBUILT_LIBRARY := ./hal/drivers/libbt/ch6121_hci.a
include ./board/ch6121evb/rom1Sym.mk
