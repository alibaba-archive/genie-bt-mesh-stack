...
/**
 * @brief      This function servers to clear the IRQ source.
 * @param[in]  none.
 * @return     none.
 */
...
/**
 * @brief      This function servers to clear the IRQ source2.
 * @param[in]  msk - variable of msk.
 * @return     none.
 */
...
/**
 * @brief      This function servers to enable the IRQ type.
 * @param[in]  msk - variable of msk.
 * @return     none.
 */
...
/**
 * @brief      This function servers to disable the IRQ type.
 * @param[in]  msk - variable of msk.
 * @return     none.
 */
...
/**
 * @brief      This function servers to enable the RF IRQ.
 * @param[in]  msk - variable of msk.
 * @return     none.
 */
...
/**
 * @brief      This function servers to disable the RF IRQ.
 * @param[in]  msk - variable of msk.
 * @return     none.
 */
