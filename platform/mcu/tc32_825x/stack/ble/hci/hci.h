...
#if 1
    /** HCI command */
    HCI_TYPE_CMD = 0,   // BT_BUF_CMD,
    /** HCI event */
    HCI_TYPE_EVENT,     // BT_BUF_EVT,
    /** Outgoing ACL data */
    HCI_TYPE_ACL_DATA,  // BT_BUF_ACL_OUT,
    /** Incoming ACL data */
    HCI_TYPE_SCO_DATA,  // BT_BUF_ACL_IN,
#else
	HCI_TYPE_CMD = 0x01,
	HCI_TYPE_ACL_DATA,
	HCI_TYPE_SCO_DATA,
...
int blc_hci_send_event_async (u32 h, u8 *para, int n);
