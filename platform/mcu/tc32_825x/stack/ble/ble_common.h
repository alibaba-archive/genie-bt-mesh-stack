...
#define LL_FEATURE_MASK_CONNECTION_PARA_REQUEST_PROCEDURE  	 0x02	//core_4.1
#define LL_FEATURE_MASK_EXTENDED_REJECT_INDICATION           0x04	//core_4.1
#define LL_FEATURE_MASK_SLAVE_INITIATED_FEATURES_EXCHANGE    0x08	//core_4.1
#define LL_FEATURE_MASK_LE_PING                              0x10   //core_4.1
#define LL_FEATURE_MASK_LE_DATA_PACKET_EXTENSION             0x20	//core_4.2
#define LL_FEATURE_MASK_LL_PRIVACY                           0x40	//core_4.2
#define LL_FEATURE_MASK_EXTENDED_SCANNER_FILTER_POLICIES     0x80   //core_4.2
#define	LL_FEATURE_MASK_LE_2M_PHY							 0x0100 //core_5.0
#define LL_FEATURE_MASK_STABLE_MOD_IND_TX					 0x0200 //core_5.0
#define LL_FEATURE_MASK_STABLE_MOD_IND_RX					 0x0400 //core_5.0
#define LL_FEATURE_MASK_LE_CODED_PHY						 0x0800 //core_5.0
#define LL_FEATURE_MASK_LE_EXT_ADV							 0x1000 //core_5.0
#define LL_FEATURE_MASK_LE_PERIOD_ADV						 0x2000 //core_5.0
#define LL_FEATURE_MASK_CSA2								 0x4000 //core_5.0
#define LL_FEATURE_MASK_LE_POW_CLS1							 0x8000 //core_5.0
...
#define         VENDOR_ID_HI_B                  0x02
#define         VENDOR_ID_LO_B                  0x11
