...
#define     OTA_FIRMWARE_SIZE_MAX           (240*1024)  // 0x3C000 // refer to board.c: ((512-32)/2) =240k; // 32k parameters now
#define     OTA_FIRMWARE_SIZE_MAX_K         (OTA_FIRMWARE_SIZE_MAX / 1024)

#ifndef		CFG_ADR_MAC
//#define		CFG_ADR_MAC						0x7E000
#endif

#ifndef		CUST_CAP_INFO_ADDR
#define		CUST_CAP_INFO_ADDR				0x7F000
#endif

#ifndef		CUST_FIRMWARE_SIGNKEY_ADDR
//#define		CUST_FIRMWARE_SIGNKEY_ADDR		0x7F180
#endif
...
#ifndef BLE_CORE_5P0_FEATURE_EN
#define BLE_CORE_5P0_FEATURE_EN								0
#endif
