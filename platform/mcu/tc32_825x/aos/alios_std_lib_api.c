...
struct tm *gmtime (const time_t *timp)
{
	...
	int START_THURSDAY    = 4;                                               //1970��1��1���������ģ������� 0��
	int leap_year[12]     = {31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};//����
	int common_year[12]   = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};//ƽ��
