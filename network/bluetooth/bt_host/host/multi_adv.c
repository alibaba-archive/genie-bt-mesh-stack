...
extern void bt_mesh_proxy_adv_init(void);
extern void bt_mesh_adv_event_init(void);
extern void bt_mesh_proxy_adv_process(void);
extern void bt_mesh_adv_event_process(void);
extern void bt_mesh_adv_timer_event_process(void);
